                      ...
                      {status === "success" ? (
                        <div className="mt-4 rounded-xl border border-[#B83280]/30 bg-[#B83280]/10 px-4 py-4">
                          ...
                          <p className="mt-1 text-sm text-white/75">
                            After we add you, Play Store access may take a few
                            minutes to activate.
                          </p>
                          ...
                          <p className="mt-3 text-xs text-white/55">
                            If you see “not available”, try again in a few
                            minutes using the same Play Store account.
                          </p>
                        </div>
                      ) : (
                        <>
                          ...
                          <p className="mt-3 text-xs text-white/55 leading-relaxed">
                            By submitting, you agree to receive Android access
                            updates from Convoo.
                          </p>
                        </>
                      )}
