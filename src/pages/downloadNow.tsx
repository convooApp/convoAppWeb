...
const APP_STORE_URL = 'https://apps.apple.com/app/apple-store/id6746660683?pt=127828181&ct=LiveOfflineEvent&mt=8';
const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.convooapp.convoo';
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-3 sm:grid-cols-3 pt-2">
                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                      ...
                      <div className="mt-1 text-sm text-white/60">Real-time chat before profiles.</div>
                    </div>
                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                    ...
                    <div className="rounded-xl border border-white/10 bg-white/5 p-4">
                      ...
                      <div className="mt-1 text-sm text-white/60">Continue only if both want to.</div>
                    </div>
                  </div>
                </div>
              )}
